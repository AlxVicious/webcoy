...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Hernan Cortes House</title>
  </head>
    ...
    <div class="container">
      ...
      <div class="container flex-md-row mx-auto pt-3 pb-3">
        <div class="text-center">
            <h1 id="fp">Hernan Cortes House</h1>
        </div>
      </div>
      <!-- Fin Titulo -->
      <!-- Cuerpo -->
      <div class="container border-3 border-bottom border-danger mb-3">
        <div class="row">
          <div class="col-sm-5 mx-auto"><!-- Descripcion -->
            <p>The Old City Hall of Coyoacán, also known as the house of Hernán Cortés, is a construction that is located on the north side of the Plaza Hidalgo de Villa Coyoacán. It is found in the catalog of historical monuments of the National Institute of Anthropology and History (INAH). Since its construction in the 18th century, it has been the administrative headquarters of the Coyoacán authorities. The erroneous name of Casa de Cortés comes from the historical association between Coyoacán and the Spanish conqueror, who lived in the place between 1521 and 1522, after that the Spaniards devastated Mexico-Tenochtitlan. While the city was being rebuilt on the ruins of the old Mexica capital, Coyoacán was the seat of the first government of New Spain.</p>
          </div>
          <div class="col-sm-auto mx-auto" style="max-width:400px;"><!-- Mapa -->
            ...
            <div class="row text-center">
              <!-- Estacionamiento -->
              <div class="col">
                <a href="https://goo.gl/maps/Ju7SSTJDKki4SxFp9"><img src="../../../img/park.png" alt="Parking" style="max-width:72px;"></a>
              </div>
              <!-- Transporte -->
              <div class="col">
          ...
          <div class="row">
            ...
            <div class="col">
              <div class="card mx-auto" style="width: 18rem;">
                <img src="../../../img/1.jpg" class="card-img-top" alt="Casa Hernan Cortes">
                <div class="card-body">
            ...
            <div class="col">
              <div class="card mx-auto" style="width: 18rem;">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">considered one of the best canteens in CDMX thanks to its variety of typical Mexican food and mezcal.</p>
                  <a href="https://goo.gl/maps/pThGt5ndoRPWqpsD6" class="btn btn-danger">Show map</a>
                </div>
              </div>
            </div>
            ...
            <div class="col">
              <div class="card mx-auto" style="width: 18rem;">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">Beautiful restaurant, inside an old building, which offers a wide variety of Mexican dishes.</p>
                  <a href="https://goo.gl/maps/bD7ne22597bwySGFA" class="btn btn-danger">Show map</a>
                </div>
              </div>
            </div>
            ...
            <div class="col">
              <div class="card mx-auto" style="width: 18rem;">
                ...
                <div class="card-body">
                  ...
                  <a href="https://goo.gl/maps/9a5heyJDDCA16GSX9" class="btn btn-danger">Show map</a>
                </div>
              </div>
            </div>
