    ...
    <div class="container">
      ...
      <div class="container flex-md-row mx-auto pt-3 pb-3">
        <div class="text-center">
            <h1 id="fp">Museo León Trotsky</h1>
        </div>
      </div>
      <!-- Fin Titulo -->
      <!-- Cuerpo -->
      <div class="container border-3 border-bottom border-danger mb-3">
        <div class="row">
          <div class="col-sm-5 mx-auto"><!-- Descripcion -->
            <p>El Museo León Trotsky se fundó en 1990 en lo que fuera la casa donde vivió Lev Davidovich Bronstein, mejor conocido como León Trotsky, líder revolucionario ruso, quien al ser perseguido por José Stalin, tras la revolución bolchevique de octubre, obtuvo asilo político del gobierno cardenista y llegó a México en 1937.</p>
          </div>
          <div class="col-sm-auto mx-auto" style="max-width:400px;"><!-- Mapa -->
            ...
            <div class="row text-center">
              <!-- Estacionamiento -->
              <div class="col">
                <a href="https://goo.gl/maps/sL7YUWGS6WmdYosZ9"><img src="../../../img/park.png" alt="Estacionamiento" style="max-width:72px;"></a>
              </div>
              <!-- Transporte -->
              <div class="col">
