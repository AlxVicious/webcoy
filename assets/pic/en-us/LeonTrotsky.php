...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Museo Leon Trotsky</title>
  </head>
      ...
      <div class="container border-3 border-bottom border-danger mb-3">
        <div class="row">
          <div class="col-sm-10 mx-auto"><!-- Descripcion -->
            <p>Lev Davídovich Bronstein, más conocido como Lev Trotski o León Trotski, fue un político y revolucionario ruso de origen judío, nacido en Yanovka, Ucrania en el año 1877.
              <br>
              <div class="text-center">
                <img src="../../../img/trotski.jpg" alt="aguacate" style="max-width:300px;">
              </div>
              <br>
            Nació en una familia judía de labradores propietarios y estudió derecho en la Universidad de Odessa. Participó desde joven en la oposición clandestina contra el régimen autocrático de los zares, organizando una Liga Obrera del Sur de Rusia (1897).<br><br>
            Fue detenido varias veces y desterrado a Siberia; pero consiguió huir de allí en 1902 y se unió en Londres al que ya aparecía como jefe de la oposición socialdemócrata en el exilio: Lenin. Aunque discrepaba de su concepción autoritaria del partido, colaboró con él e intentó en vano reconciliar a la facción que dirigía (los bolcheviques) con la facción rival de la socialdemocracia rusa (los mencheviques).
              <br>
              <div class="text-center">
                <img src="../../../img/trotski2.jpg" alt="aguacate" style="max-width:300px;">
              </div>
              <br>
              Fue detenido varias veces y desterrado a Siberia; pero consiguió huir de allí en 1902 y se unió en Londres al que ya aparecía como jefe de la oposición socialdemócrata en el exilio: Lenin. Aunque discrepaba de su concepción autoritaria del partido, colaboró con él e intentó en vano reconciliar a la facción que dirigía (los bolcheviques) con la facción rival de la socialdemocracia rusa (los mencheviques).
              <br>
              ...
              <br>
              <div class="text-center">
                <img src="../../../img/trotski3.jpg" alt="aguacate" style="max-width:300px;">
              </div>
              <br>
              ...
              <br>
              <div class="text-center">
                <img src="../../../img/trotski4.jpg" alt="aguacate" style="max-width:300px;">
              </div>
              <br>
              ...
              <br>
              <div class="text-center">
                <img src="../../../img/trotski5.jpg" alt="aguacate" style="max-width:300px;">
              </div>
              <br>
