...
<html lang="en" dir="ltr">
  ...
  <body ondragstart="return false" onselectstart="return false" oncontextmenu="return false">
    <input type="hidden" id="title" value="contacto.html">
    <div class="container">
      ...
      <div class="container border-3 border-bottom border-danger mb-3">
        <div class="row">
          <div class="col-sm-5 mx-auto"><!-- Descripcion -->
            <h4>Address: Jardin Hidalgo No. 1, Alcaldia Coyoacán, Ciudad de México, C.P. 04000</h4>
            <h4>Phone Number: 55-9848-1373</h4>
            <h4>Email: alcaldiacoyacan@cdmx.gob.mx</h4>
          </div>
